...
namespace LibrarySample
{
    public static class ImageSources
    {
        ...
        public static readonly string UwpIconPath = @"Assets\UWP.png";
        ...
        public static readonly ImageSource UwpIconSource = new BitmapImage(new Uri(System.IO.Directory.GetCurrentDirectory() + '\\' + UwpIconPath));
        ...
        public static readonly IconSource UwpImageSource = new ImageIconSource { ImageSource = UwpIconSource };
