...
namespace LibrarySample.Pages
{
    ...
    public sealed partial class CppWinRTNamespacePage : Page, ICppWinRTHandler, IXml
    {
        ...
        {
            LibraryPageHelper.ApplyClasses(RootPanel, XElement, "Classes", "ÉNÉâÉX", XmlPath.CppWinRTNamespaceLibraryDirectory, LibraryType.CppWinRTNamespaceLibrary, Category.Class);
        }

        private void ApplyStructures()
        {
            LibraryPageHelper.ApplyClasses(RootPanel, XElement, "Structures", "ç\ë¢ëÃ", XmlPath.CppWinRTNamespaceLibraryDirectory, LibraryType.CppWinRTNamespaceLibrary, Category.Structure);
        }
    }
}
