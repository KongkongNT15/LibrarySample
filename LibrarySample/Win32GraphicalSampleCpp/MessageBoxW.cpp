...
LRESULT CALLBACK Kongkong::WinUser::MessageBoxWProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    static HWND hTitleEdit = nullptr;
    static HWND hMessageEdit = nullptr;
    static HWND hIconsComboBox = nullptr;
    static HWND hButtonComboBox = nullptr;
    static HWND hResultText = nullptr;
    ...
    switch (uMsg)
    {
        ...
        case WM_CREATE:
            CreateWindow(
                ...
                WS_CHILD | WS_VISIBLE,
                20, 20, 300, 16,
                hwnd, (HMENU)IDC_STATIC, Program::HInstance(), nullptr);
            ...
            hButtonComboBox = CreateWindowEx(
                ...
                WS_CHILD | WS_VISIBLE | WS_VSCROLL | CBS_DROPDOWNLIST,
                20, 290, 160, 20,
                hwnd, (HMENU)IDC_COMBOBOX2, Program::HInstance(), nullptr);
            ...
            CreateWindow(L"BUTTON", L"表示", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 20, 350, 64, 24, hwnd, (HMENU)IDC_BUTTON1, Program::HInstance(), nullptr);
        ...
        case WM_COMMAND:
            switch (LOWORD(wParam))
            {
                case IDC_BUTTON1:
                {
                    ...
                    wchar_t* title = (wchar_t*)malloc(titleLength * sizeof(wchar_t));
                    wchar_t* message = (wchar_t*)malloc(messageLength * sizeof(wchar_t));
