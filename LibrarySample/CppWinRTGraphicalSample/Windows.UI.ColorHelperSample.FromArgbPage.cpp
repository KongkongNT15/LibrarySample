...
namespace Kongkong::Windows::UI::ColorHelperSample
{
	...
	void FromArgbPage::SliderValueChanged(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs const& args)
	{
		ApplyColor();
	}

	void FromArgbPage::ApplyColor()
	{
	...
	void FromArgbPage::SetSlider(winrt::Windows::UI::Xaml::Controls::Slider const& slider, winrt::Windows::UI::Xaml::Controls::StackPanel const& rootPanel, winrt::hstring const& title)
	{
		slider.Width(320);
		...
		slider.ValueChanged({ this, &FromArgbPage::SliderValueChanged });
