...
namespace LibrarySample.Pages
{
    ...
    public sealed partial class Win32LibraryPage : Page, IXml, IWin32Handler
    {
        ...
        {
            await LibraryPageHelper.ApplyFunctionsAsync(RootPanel, XElement, "Functions", "ä÷êî", LibraryType.Win32Library, Category.Function);
        }

        private async Task ApplyFunctionMacros()
        {
            await LibraryPageHelper.ApplyFunctionsAsync(RootPanel, XElement, "FunctionMacros", "ä÷êîÉ}ÉNÉç", LibraryType.Win32Library, Category.Macro);
        }
