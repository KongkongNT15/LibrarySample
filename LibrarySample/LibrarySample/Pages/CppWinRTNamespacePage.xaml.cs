...
namespace LibrarySample.Pages
{
    ...
    public sealed partial class CppWinRTNamespacePage : Page, ICppWinRTHandler, IXml
    {
        ...
        {
            LibraryPageHelper.ApplyClasses(RootPanel, XElement, "Classes", "ÉNÉâÉX", Library.CppWinRTNamespace, Category.Class);
        }
        ...
        {
            await LibraryPageHelper.ApplyFunctionsAsync(RootPanel, XElement, "Functions", "ä÷êî", Library.CppWinRTNamespace, Category.Function);
        }
    }
}
